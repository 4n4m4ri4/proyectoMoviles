...
class ProductListGalletas : AppCompatActivity() {
    lateinit var lista: ListView
    lateinit var botonCarritoGalleta: FloatingActionButton
    var listaProductos= arrayListOf<Product>()
    lateinit var textoVacio: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_product_list_galletas)


        botonCarritoGalleta=findViewById(R.id.botonCarritoGalleta)
        lista=findViewById(R.id.listViewProductsGalletas)
        textoVacio=findViewById(R.id.textoVistaVaciaGalleta)
        ...
        botonCarritoGalleta.setOnClickListener {
        ...
        db.collection("productos")
            ...
            .addOnSuccessListener { result ->
                for (document in result ) {
                    ...
                    if(currentProduct.categoria=="galleta" || currentProduct.categoria=="Galleta" ) {
