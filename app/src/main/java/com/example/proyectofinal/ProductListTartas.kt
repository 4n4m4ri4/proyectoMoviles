...
class ProductListTartas : AppCompatActivity() {
    lateinit var lista: ListView
    lateinit var botonCarritoTarta: FloatingActionButton
    var listaProductos= arrayListOf<Product>()
    lateinit var textoVacio:TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_product_list_tartas)

        botonCarritoTarta=findViewById(R.id.botonCarritoTarta)
        lista=findViewById(R.id.listViewProductsTartas)
        textoVacio=findViewById(R.id.textoVistaVaciaTarta)
        ...
        botonCarritoTarta.setOnClickListener {
        ...
        db.collection("productos")
            ...
            .addOnSuccessListener { result ->
                for (document in result ) {
                    ...
                    if(currentProduct.categoria=="tarta" || currentProduct.categoria=="Tarta" ) {
